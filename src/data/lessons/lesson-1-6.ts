      ...
      steps: [
        {
          ...
          scene: {
            devices: [
              ...
              { id: 'pc1', type: 'pc', label: '.1', position: { x: 80, y: 400 } },
              { id: 'pc2', type: 'pc', label: '.2', position: { x: 200, y: 400 } },
              { id: 'pc3', type: 'laptop', label: '.65', position: { x: 350, y: 400 } },
              { id: 'pc4', type: 'laptop', label: '.66', position: { x: 460, y: 400 } },
              { id: 'pc5', type: 'pc', label: '.129', position: { x: 620, y: 400 } },
              { id: 'pc6', type: 'pc', label: '.130', position: { x: 740, y: 400 } },
            ],
            cables: [
            ...
            packets: [
              {
                ...
                color: '#4a7fb8',
                hops: [
                  { fromDevice: 'pc1', toDevice: 'sw1', hint: 'IT-PC (192.168.1.1) will an einen Vertriebs-PC (192.168.1.129). Andere Subnetze → Paket muss zum Gateway.' },
