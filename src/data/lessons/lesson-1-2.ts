      ...
      steps: [
        {
          ...
          scene: {
            devices: [
              { id: 'spine1', type: 'l3switch', label: 'Spine 1\n100G', position: { x: 210, y: 70 } },
              { id: 'spine2', type: 'l3switch', label: 'Spine 2\n100G', position: { x: 440, y: 70 } },
              { id: 'spine3', type: 'l3switch', label: 'Spine 3\n100G', position: { x: 670, y: 70 } },
              { id: 'leaf1', type: 'switch', label: 'Leaf 1\nRack A', position: { x: 140, y: 300 } },
              { id: 'leaf2', type: 'switch', label: 'Leaf 2\nRack B', position: { x: 340, y: 300 } },
              { id: 'leaf3', type: 'switch', label: 'Leaf 3\nRack C', position: { x: 540, y: 300 } },
              { id: 'leaf4', type: 'switch', label: 'Leaf 4\nRack D', position: { x: 740, y: 300 } },
              { id: 'srv1', type: 'server', label: 'Web Cluster', position: { x: 140, y: 480 } },
              { id: 'srv2', type: 'server', label: 'App Server', position: { x: 340, y: 480 } },
              { id: 'srv3', type: 'server', label: 'Database', position: { x: 540, y: 480 } },
              { id: 'srv4', type: 'server', label: 'Storage', position: { x: 740, y: 480 } },
            ],
            cables: [
